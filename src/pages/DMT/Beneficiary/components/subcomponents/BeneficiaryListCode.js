    ...
    <>
     <Row className="codebg">
      ...
      <p id="php">
        ...
        <code>CURLOPT_URL =&#62; <code className="code-yellow">'http://194.195.113.218:8090/paymento/beneficiary-reg/getbeneficiary',</code></code>
        ...
        <code>CURLOPT_FOLLOWLOCATION =&#62;  <code className="code-yelllow">true,</code></code>
